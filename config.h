...
#define HAVE_SFFTW Define if have the single-precision FFTW libraries
...
/* "top build dir" */
#define TOP_BUILDDIR "/scratch2/CODES/xoopic"

/* "top src dir" */
#define TOP_SRCDIR "/scratch2/CODES/xoopic"
